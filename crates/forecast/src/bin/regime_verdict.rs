...
//! `evidence/v1/v3-regime-classifier/reports/`.
//!
//! ## Usage
//!
//! ```bash
...
//! - NO modification of any anchored report under `evidence/*/reports/`.
...
#[command(
    ...
    long_about = "Re-runs the held-out 2024 val-window regime-dispatcher scenario and\n\
                  emits a V-REG-1..V-REG-5 verdict report under evidence/v1/v3-regime-classifier/reports/.\n\n\
...
struct Args {
    ...
    /// Default: evidence/v1/v3-regime-classifier/reports/
    #[arg(long)]
...
fn main() -> Result<()> {
    ...
    llm::tracing_init::install_global(&["regime_verdict=info", "forecast=info"], false)?;
    ...
    let out_dir: PathBuf = args
        .out_dir
        .clone()
        .unwrap_or_else(|| PathBuf::from("evidence/v1/v3-regime-classifier/reports/"));
