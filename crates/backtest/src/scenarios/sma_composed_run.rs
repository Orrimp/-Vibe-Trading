...
pub fn synthetic_bars_minute(
    ...
    // evidence/v1/v0-paper-sma/reports etc.) remain byte-identical. Other symbols get
...
/// `evidence/v1/v0-paper-sma/reports/` etc.) stay byte-identical. All other symbols
