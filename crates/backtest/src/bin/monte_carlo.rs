...
//!   --out-dir spec/strategy-robustness-harness/reports/
//!
...
//! N=$(ls spec/strategy-robustness-harness/reports/robustness-*.md 2>/dev/null | wc -l | tr -d " ")
...
//! ## Cross-references
//!
//! - `spec/strategy-robustness-harness/feature.md` § Design D-C2.1..D-C2.9
...
struct Args {
    ...
    #[arg(long, default_value = "spec/strategy-robustness-harness/reports/")]
    out_dir: PathBuf,
