...
//! `spec/v1/strategy-robustness-harness/reports/`.
//!
//! ## ADR-0051 compliance
//!
...
//!   --out-dir spec/v1/strategy-robustness-harness/reports/
//!
...
//! N=$(ls spec/v1/strategy-robustness-harness/reports/robustness-*.md 2>/dev/null | wc -l | tr -d " ")
...
struct Args {
    ...
    #[arg(long, default_value = "spec/v1/strategy-robustness-harness/reports/")]
    out_dir: PathBuf,
