...
//!     --window-bars 1000 \
//!     --out-dir evidence/v1/v3-llm-forecaster/reports/
//! ```
//!
//! ## Read-only contract
//!
...
use clap::Parser;
use tracing::info;
// EnvFilter now used via llm::tracing_init::install_global (T-RED-D11).
...
struct Args {
    ...
    #[arg(long, default_value = "evidence/v1/v3-llm-forecaster/reports/")]
    out_dir: PathBuf,
