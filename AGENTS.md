...
3. **AGENTS.md** (this file) — coding rules + skills + non-negotiables.
...
- **Personas** are invoked via their skills — `bmad-agent-{analyst,architect,dev,
  ...
  non-negotiables, harness-skill menus). The six legacy `.Codex/agents/*`
...
- The test-report template is still the contract for test output:
  [.Codex/skills/rust-test/templates/test-report.md](.Codex/skills/rust-test/templates/test-report.md).
...
│                             #   pre-bmad-agents/ (retired .Codex/agents/)
...
Project harness skills (ours, under `.Codex/skills/`; humans reference them by name):

- [`rust-build`](.Codex/skills/rust-build/SKILL.md) · [`rust-test`](.Codex/skills/rust-test/SKILL.md) · [`rust-validate`](.Codex/skills/rust-validate/SKILL.md) · [`rust-bench`](.Codex/skills/rust-bench/SKILL.md) · [`rust-coverage`](.Codex/skills/rust-coverage/SKILL.md) · [`rust-mutants`](.Codex/skills/rust-mutants/SKILL.md)
- [`backtest`](.Codex/skills/backtest/SKILL.md) · [`verify-anchors`](.Codex/skills/verify-anchors/SKILL.md) · [`spec-lint`](.Codex/skills/spec-lint/SKILL.md) · [`spec-brief`](.Codex/skills/spec-brief/SKILL.md)
- [`cockpit-smoke`](.Codex/skills/cockpit-smoke/SKILL.md) (orchestrator-only) · [`capture-screenshot`](.Codex/skills/capture-screenshot/SKILL.md) · [`present-results`](.Codex/skills/present-results/SKILL.md)
- [`spec-update`](.Codex/skills/spec-update/SKILL.md) — **RETIRED** at Phase 5c per ratified decision D5; use the BMAD write-paths.
