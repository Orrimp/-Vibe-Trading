            ...
            for layer in self.layers.iter() {
                ...
                if !layer.primitives.is_empty() {
                    ...
                    for group in &layer.primitives {
                        // chart-fixture-line-clipping fix backported from iced
                        // master commit 76b32d4906 (Jan 28, 2026):
                ...
                if !layer.text.is_empty() {
                    ...
                    for group in &layer.text {
                        for text in group.as_slice() {
                            // chart-fixture-line-clipping fix backported from
                            // iced master commit 76b32d4906 (Jan 28, 2026).
