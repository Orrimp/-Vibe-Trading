...
- **Render-verified PNGs (durable):** `docs/runbooks/assets/advisor-demo/stage_stepper_{data,calibrate,analyze,suggest,off_journey}.png`
- **Real-data buy-and-hold stdout (durable, fresh 2026-07-09):** `docs/runbooks/artifacts/advisor-end-to-end-demo-2026-07-09/t6_2-buyhold-realdata-run.txt`
- **Whole-field T14 run log (durable; records the stale-guard panic honestly):** `docs/runbooks/artifacts/advisor-end-to-end-demo-2026-07-09/t14-bakeoff-run.txt`
