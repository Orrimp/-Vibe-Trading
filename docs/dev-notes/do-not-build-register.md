...
> §3 (OT-1..OT-10), `docs/dev-notes/post-v2-scoping-2026-07-09.md` §4, and dated
...
| B-2 | **Live trading / real orders / margin / KYC** — "wire it to a real exchange so the €200 is real; add a live-exec client." | **PAPER / SIM ONLY** — standing operator constraint. Live execution was **built and then removed from `main` 2026-06-12** by explicit operator direction ("no live trading for a long time"); the whole `crates/exec/src/live/` block, secrets plumbing, and the live reconciler were reverted byte-exact. | Do NOT re-propose. Any maker/limit cost mode stays a *simulation assumption*, clearly labelled, never a step toward execution. `docs/dev-notes/live-trading-removed-2026-06-12.md`; product.md § IS NOT + § Constraints; project memory "no live trading"; v2-analysis §3 OT-2. |
...
`docs/dev-notes/qlib-feature-gap-2026-06-17.md` gap #1 and project memory
...
(`docs/dev-notes/post-v2-scoping-2026-07-09.md` §3).
...
- 2026-07-09 (analyst, R3-4a): created the authoritative do-not-build register —
  ...
  Consolidates `docs/dev-notes/post-v2-scoping-2026-07-09.md` §4, `spec/v2/v2-analysis.md`
