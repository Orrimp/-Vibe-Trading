...
version: 0.1.0
intended-location: docs/dev-notes/2026-05-13-spec-hygiene-plan.md
---
...
`docs/dev-notes/audit-YYYY-MM-DD.md` listing:
...
**Acceptance.**
- Weekly dev-note appears in `docs/dev-notes/` without manual prompting.
...
`docs/dev-notes/reverse-spec-YYYY-MM-DD.md` describing what the code
...
`spec-update` skill to move it into `docs/dev-notes/2026-05-13-spec-hygiene-plan.md`
