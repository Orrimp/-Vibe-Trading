...
(`docs/dev-notes/bug-64-yahoo-run-code-map-2026-05-29.md`, commit
...
- Write `_bmad-output/planning-artifacts/architecture/decisions/0050-iced-tokio-runtime-context-and-cancellation.md`
- Add row to `_bmad-output/planning-artifacts/architecture/decisions/README.md` table in same commit
