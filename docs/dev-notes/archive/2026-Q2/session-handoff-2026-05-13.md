...
Documented in [`docs/dev-notes/orchestrator-tooling-2026-05-12.md`](orchestrator-tooling-2026-05-12.md). All allowlisted in `.claude/settings.local.json`.
...
- **Bounded transitions allowed** in `docs/ui-design-principles.md:62` per Q-O1 amendment 2026-05-13.
