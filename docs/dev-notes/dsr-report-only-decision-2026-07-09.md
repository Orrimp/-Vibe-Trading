...
`docs/dev-notes/post-v2-scoping-2026-07-09.md` §3 R3-3b): the operator kept report-only
...
- `_bmad-output/planning-artifacts/architecture/decisions/0075-overfitting-scorecard.md` (the report-only scorecard).
...
- `docs/dev-notes/post-v2-scoping-2026-07-09.md` §3 R3-3, §4 (off-track register row
  on the veto).
