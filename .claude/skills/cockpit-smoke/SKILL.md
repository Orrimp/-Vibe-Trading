...
2. **Spawn cockpit in background, capture stderr, wait, kill.**
   ...
   The 7s window is the hypothesis; per `spec/ui-quality-gate-overhaul/feature.md ## H-A4`, the first three real runs against the post-F1 commit are MEASURED — if any exceeds 5s, bump to 10s and record the calibration in the feature's changelog.
