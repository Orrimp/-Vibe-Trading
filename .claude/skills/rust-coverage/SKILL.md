...
references:
  - spec/dev-notes/testing-framework-audit-2026-05-25.md § R2
  - spec/dev-notes/testing-strategy-review-2026-05-25.md § §3 Coverage in this project's context
---
...
Cross-references:
- Architect recommendation: `spec/dev-notes/testing-framework-audit-2026-05-25.md § R2`
  ("Adopt `cargo-llvm-cov` in non-gating warning mode, 2-week soak, then
  per-crate floors — HIGH ROI")
- Analyst strategic framing: `spec/dev-notes/testing-strategy-review-2026-05-25.md § §3`
