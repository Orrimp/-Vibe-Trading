...
- Provenance: `git log -- spec/v1/lab-recipe-test-harness` (full narrative); reports under `spec/v1/lab-recipe-test-harness/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
