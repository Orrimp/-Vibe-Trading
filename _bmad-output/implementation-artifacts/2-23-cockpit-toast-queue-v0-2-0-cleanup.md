...
- Provenance: `git log -- spec/v1/cockpit-toast-queue-v0.2.0-cleanup` (full narrative); reports under `evidence/v1/cockpit-toast-queue-v0.2.0-cleanup/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
