...
- Provenance: `git log -- spec/v1/v2-llm-strategy` (full narrative); reports under `evidence/v1/v2-llm-strategy/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
