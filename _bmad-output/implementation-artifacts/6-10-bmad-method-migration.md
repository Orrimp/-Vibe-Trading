...
- [ ] Phase 3 - move report corpus -> `evidence/`, base-swap anchors (must hold 119/119 in the same commit)
- [ ] Phase 4 - move knowledge -> `docs/`
...
- CHANGELOG index: not yet in CHANGELOG (live work; plan: spec/dev-notes/bmad-migration-plan-2026-07-24.md).
...
- Plan: `spec/dev-notes/bmad-migration-plan-2026-07-24.md` (ratified 2026-07-24, all 7 decisions resolved).
