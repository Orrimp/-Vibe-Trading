...
- Provenance: `git log -- spec/v1/ui-rethink-phase-a-lab` (full narrative); reports under `evidence/v1/ui-rethink-phase-a-lab/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
