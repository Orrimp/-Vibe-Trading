...
- Provenance: `git log -- spec/v1/cross-sectional-mean-reversion-strategy` (full narrative); reports under `spec/v1/cross-sectional-mean-reversion-strategy/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).

### References

- Trace: `REQ-XS-MEANREVERSION-001` (state=`tested`)
