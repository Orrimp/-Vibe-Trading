...
- Provenance: `git log -- spec/v1/iced-native-widgets` (full narrative); reports under `spec/v1/iced-native-widgets/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
