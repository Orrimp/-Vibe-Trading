...
- Provenance: `git log -- spec/v1/lab-yahoo-empty-range-ux` (full narrative); reports under `spec/v1/lab-yahoo-empty-range-ux/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
