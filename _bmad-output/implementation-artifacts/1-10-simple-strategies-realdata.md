...
- Provenance: `git log -- spec/v1/simple-strategies-realdata` (full narrative); reports under `spec/v1/simple-strategies-realdata/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
