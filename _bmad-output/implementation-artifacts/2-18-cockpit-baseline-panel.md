...
- Provenance: `git log -- spec/v1/cockpit-baseline-panel` (full narrative); reports under `spec/v1/cockpit-baseline-panel/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
