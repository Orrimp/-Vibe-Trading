...
- Provenance: `git log -- spec/v3/advisor-pit-discipline` (full narrative); reports under `spec/v3/advisor-pit-discipline/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
