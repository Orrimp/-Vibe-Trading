...
- Provenance: `git log -- spec/v1/advisor-eur-fx` (full narrative); reports under `spec/v1/advisor-eur-fx/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
