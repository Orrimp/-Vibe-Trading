...
- Provenance: `git log -- spec/v1/bug-64-d11-attempt-3-yahoo-run-runtime-context` (full narrative); reports under `spec/v1/bug-64-d11-attempt-3-yahoo-run-runtime-context/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
