...
- Provenance: `git log -- spec/v2/advisor-narration-faithfulness` (full narrative); reports under `spec/v2/advisor-narration-faithfulness/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
