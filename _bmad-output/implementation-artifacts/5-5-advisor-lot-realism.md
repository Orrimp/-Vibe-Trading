...
- Provenance: `git log -- spec/v3/advisor-lot-realism` (full narrative); reports under `spec/v3/advisor-lot-realism/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
