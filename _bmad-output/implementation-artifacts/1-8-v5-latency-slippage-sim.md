...
- Provenance: `git log -- spec/v5-latency-slippage-sim` (full narrative); reports under `evidence/v5-latency-slippage-sim/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
