...
- Provenance: `git log -- spec/v1/v1-cross-sectional-momentum` (full narrative); reports under `spec/v1/v1-cross-sectional-momentum/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
