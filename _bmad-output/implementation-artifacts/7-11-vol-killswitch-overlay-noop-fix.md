...
- Provenance: `git log -- spec/v1/vol-killswitch-overlay-noop-fix` (full narrative); reports under `spec/v1/vol-killswitch-overlay-noop-fix/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
