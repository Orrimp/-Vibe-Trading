...
- Provenance: `git log -- spec/v1/per-symbol-position-accounts` (full narrative); reports under `spec/v1/per-symbol-position-accounts/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
