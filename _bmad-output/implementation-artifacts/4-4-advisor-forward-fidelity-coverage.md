...
- Provenance: `git log -- spec/v2/advisor-forward-fidelity-coverage` (full narrative); reports under `spec/v2/advisor-forward-fidelity-coverage/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
