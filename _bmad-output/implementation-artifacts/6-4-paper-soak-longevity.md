...
- Provenance: `git log -- spec/v1/paper-soak-longevity` (full narrative); reports under `spec/v1/paper-soak-longevity/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
