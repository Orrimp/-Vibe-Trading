...
- Provenance: `git log -- spec/v1/operator-success-reports` (full narrative); reports under `spec/v1/operator-success-reports/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
