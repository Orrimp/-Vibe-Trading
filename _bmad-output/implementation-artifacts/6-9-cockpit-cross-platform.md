...
- Provenance: `git log -- spec/cockpit-cross-platform` (full narrative); reports under `spec/cockpit-cross-platform/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
