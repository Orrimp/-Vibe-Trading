...
- Provenance: `git log -- spec/v1/cockpit-activity-status-bar` (full narrative); reports under `evidence/v1/cockpit-activity-status-bar/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
