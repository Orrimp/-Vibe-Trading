...
- Provenance: `git log -- spec/v1/perp-basis-signal-robustness` (full narrative); reports under `spec/v1/perp-basis-signal-robustness/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
