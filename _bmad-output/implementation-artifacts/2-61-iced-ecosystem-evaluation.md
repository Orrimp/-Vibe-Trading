...
- Provenance: `git log -- spec/iced-ecosystem-evaluation` (full narrative); reports under `spec/iced-ecosystem-evaluation/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
