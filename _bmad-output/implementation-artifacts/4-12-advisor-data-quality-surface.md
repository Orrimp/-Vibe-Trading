...
- Provenance: `git log -- spec/v2/advisor-data-quality-surface` (full narrative); reports under `spec/v2/advisor-data-quality-surface/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
