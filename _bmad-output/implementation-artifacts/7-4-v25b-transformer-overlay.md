...
- Provenance: `git log -- spec/v1/v25b-transformer-overlay` (full narrative); reports under `evidence/v1/v25b-transformer-overlay/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
