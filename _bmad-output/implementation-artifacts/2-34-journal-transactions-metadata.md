...
- Provenance: `git log -- spec/v1/journal-transactions-metadata` (full narrative); reports under `evidence/v1/journal-transactions-metadata/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
