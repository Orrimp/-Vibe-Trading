...
- Provenance: `git log -- spec/v1/time-series-momentum-robustness` (full narrative); reports under `spec/v1/time-series-momentum-robustness/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).

### References

- Trace: `REQ-TIME-SERIES-MOMENTUM-ROBUSTNESS-001` (state=`tester-done`)
