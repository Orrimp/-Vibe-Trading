...
- Provenance: `git log -- spec/v1/v26-forecast-bakeoff` (full narrative); reports under `spec/v1/v26-forecast-bakeoff/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
