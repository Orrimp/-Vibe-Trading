...
- Provenance: `git log -- spec/v1/real-mtm-unrealized-pnl` (full narrative); reports under `evidence/v1/real-mtm-unrealized-pnl/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
