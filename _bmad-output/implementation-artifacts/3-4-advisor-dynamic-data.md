...
- Provenance: `git log -- spec/v1/advisor-dynamic-data` (full narrative); reports under `spec/v1/advisor-dynamic-data/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
