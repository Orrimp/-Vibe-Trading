...
- Provenance: `git log -- spec/v1/momentum-parameter-robustness-sweep` (full narrative); reports under `spec/v1/momentum-parameter-robustness-sweep/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).

### References

- Trace: `REQ-MOMENTUM-PARAMETER-ROBUSTNESS-SWEEP-001` (state=`tested`)
