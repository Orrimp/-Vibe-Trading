...
- Provenance: `git log -- spec/v1/operator-ledger-schema-lint` (full narrative); reports under `spec/v1/operator-ledger-schema-lint/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
