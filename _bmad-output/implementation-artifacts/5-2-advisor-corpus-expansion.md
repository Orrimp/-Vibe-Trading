...
- Provenance: `git log -- spec/v3/advisor-corpus-expansion` (full narrative); reports under `spec/v3/advisor-corpus-expansion/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
