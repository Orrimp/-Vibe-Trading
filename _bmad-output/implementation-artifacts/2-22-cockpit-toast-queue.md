...
- Provenance: `git log -- spec/v1/cockpit-toast-queue` (full narrative); reports under `evidence/v1/cockpit-toast-queue/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
