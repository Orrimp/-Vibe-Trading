...
- Provenance: `git log -- spec/v1/iced-aw-cherry-pick` (full narrative); reports under `evidence/v1/iced-aw-cherry-pick/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
