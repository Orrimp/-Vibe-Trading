...
- [ ] `strategy-robustness-harness` 0.1.1 - the base feature (dev-done)
...
- Provenance: `git log -- spec/v1/strategy-robustness-harness` (full narrative); reports under `spec/v1/strategy-robustness-harness/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).

### References

- Trace: `REQ-STRATEGY-ROBUSTNESS-HARNESS-001` (state=`tested`)
