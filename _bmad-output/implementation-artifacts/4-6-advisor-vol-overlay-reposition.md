...
- Provenance: `git log -- spec/v2/advisor-vol-overlay-reposition` (full narrative); reports under `spec/v2/advisor-vol-overlay-reposition/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
