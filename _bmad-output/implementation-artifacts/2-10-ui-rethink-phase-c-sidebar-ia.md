...
- Provenance: `git log -- spec/v1/ui-rethink-phase-c-sidebar-ia` (full narrative); reports under `spec/v1/ui-rethink-phase-c-sidebar-ia/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
