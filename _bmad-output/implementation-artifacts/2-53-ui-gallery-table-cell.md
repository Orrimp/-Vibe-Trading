...
- Provenance: `git log -- spec/ui-gallery-table-cell` (full narrative); reports under `spec/ui-gallery-table-cell/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
