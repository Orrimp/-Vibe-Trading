...
- Provenance: `git log -- spec/v1/ui-headless-emulator` (full narrative); reports under `evidence/v1/ui-headless-emulator/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
