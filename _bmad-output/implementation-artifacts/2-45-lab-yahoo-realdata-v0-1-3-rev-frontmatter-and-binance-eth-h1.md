...
- Provenance: `git log -- spec/v1/lab-yahoo-realdata-v0.1.3-rev-frontmatter-and-binance-eth-h1` (full narrative); reports under `spec/v1/lab-yahoo-realdata-v0.1.3-rev-frontmatter-and-binance-eth-h1/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
