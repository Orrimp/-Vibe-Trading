...
- Provenance: `git log -- spec/v1/v3-regime-classifier` (full narrative); reports under `spec/v1/v3-regime-classifier/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
