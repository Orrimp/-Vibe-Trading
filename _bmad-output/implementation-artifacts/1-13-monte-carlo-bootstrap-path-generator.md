...
- Provenance: `git log -- spec/v1/monte-carlo-bootstrap-path-generator` (full narrative); reports under `spec/v1/monte-carlo-bootstrap-path-generator/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
