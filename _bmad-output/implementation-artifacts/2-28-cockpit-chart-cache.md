...
- Provenance: `git log -- spec/v1/cockpit-chart-cache` (full narrative); reports under `spec/v1/cockpit-chart-cache/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
