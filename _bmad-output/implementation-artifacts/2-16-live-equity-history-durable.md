...
- Provenance: `git log -- spec/v1/live-equity-history-durable` (full narrative); reports under `spec/v1/live-equity-history-durable/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
