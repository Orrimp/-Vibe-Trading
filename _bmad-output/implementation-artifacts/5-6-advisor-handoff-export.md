...
- Provenance: `git log -- spec/v3/advisor-handoff-export` (full narrative); reports under `evidence/v3/advisor-handoff-export/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
