...
- Provenance: `git log -- spec/v1/v25-dl-forecast-overlay` (full narrative); reports under `evidence/v1/v25-dl-forecast-overlay/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
