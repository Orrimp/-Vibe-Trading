...
- Provenance: `git log -- spec/v1/ui-rethink-phase-b-lab-run` (full narrative); reports under `evidence/v1/ui-rethink-phase-b-lab-run/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
