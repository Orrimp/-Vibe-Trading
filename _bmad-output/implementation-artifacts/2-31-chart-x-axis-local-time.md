...
- Provenance: `git log -- spec/v1/chart-x-axis-local-time` (full narrative); reports under `evidence/v1/chart-x-axis-local-time/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
