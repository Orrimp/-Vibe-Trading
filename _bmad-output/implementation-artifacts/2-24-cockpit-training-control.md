...
- Provenance: `git log -- spec/v1/cockpit-training-control` (full narrative); reports under `evidence/v1/cockpit-training-control/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
