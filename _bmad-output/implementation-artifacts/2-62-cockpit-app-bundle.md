...
- Provenance: `git log -- spec/cockpit-app-bundle` (full narrative); reports under `evidence/cockpit-app-bundle/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
