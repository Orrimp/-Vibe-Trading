...
- Provenance: `git log -- spec/v1/v0-paper-sma` (full narrative); reports under `evidence/v1/v0-paper-sma/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
