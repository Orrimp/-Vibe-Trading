...
- Provenance: `git log -- spec/v1/advisor-short-selling` (full narrative); reports under `spec/v1/advisor-short-selling/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
