...
- Provenance: `git log -- spec/v1/advisor-ensemble` (full narrative); reports under `evidence/v1/advisor-ensemble/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
