...
- Provenance: `git log -- spec/v1/ui-gallery-bin` (full narrative); reports under `spec/v1/ui-gallery-bin/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
