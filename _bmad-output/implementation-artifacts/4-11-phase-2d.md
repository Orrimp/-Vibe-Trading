...
- Provenance: `git log -- spec/v2/phase-2d` (full narrative); reports under `evidence/v2/phase-2d/reports/` where present (anchored report bodies are byte-immutable - ADR-0038 §D6).
