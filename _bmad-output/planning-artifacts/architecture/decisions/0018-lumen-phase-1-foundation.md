...
Lumen palette per `docs/design/project/colors_and_type.css`:
...
All Lumen palette / numbers come from `docs/design/project/`
...
Single-file `docs/ui-design-principles.md` supersedes the prior
...
- `crates/ui/src/theme.rs` is the executable contract. When
  `theme.rs` and `docs/design/` diverge, **theme.rs wins** — it's
...
- The ui-designer agent (`.claude/agents/ui-designer.md`) cites
  ...
  `ui-design-principles.md`, and `docs/design/`. ADR-0018 codifies
  that hierarchy.
