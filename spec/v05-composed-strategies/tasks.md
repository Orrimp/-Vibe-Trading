...
- `spec/v0-paper-sma/reports/screenshots/README.md` — ui-designer only
...
- [x] **T520** [developer] — Four backtest scenarios execution per
  ...
  `spec/<feature>/reports/backtest-<stamp>-<scenario-slug>.md`. —
...
- [x] **T528** [ui-designer] — Extend
  `spec/v0-paper-sma/reports/screenshots/README.md` with a
...
- [x] **T_FINAL_B** [ui-designer] — UI smoke extension:
  ...
  - Manual smoke: during a local `ReplayFeed` run, edit one of the
    ...
    `spec/v0-paper-sma/reports/screenshots/` (or sibling dir
  ...
  screenshots + state reference in `spec/<slug>/reports/screenshots/…/README.md`
