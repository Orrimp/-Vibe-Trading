...
backtest produces a report under `spec/<slug>/reports/`, the cockpit renders a
...
- **R5.5** The backtest run emits a report conforming to
  ...
  `spec/<feature>/reports/backtest-<YYYY-MM-DD-HHMM>-<scenario-slug>.md`.
...
report under `spec/<slug>/reports/`, (c) producing a full year of ledger
...
- **Seed:** `0xC0FFEE`
- **Baseline report:** `spec/v0-paper-sma/reports/backtest-<stamp>-btc-2023-1m-sma-cross.md`
...
- **V3 Both backtest scenarios run end-to-end.**
  ...
  - `btc-2024-h1-sma-cross` produces
    `spec/v0-paper-sma/reports/backtest-<stamp>-btc-2024-h1-sma-cross.md` with
...
- **PNG screenshots** (8 files listed in the checklist). The headless
  ...
  `spec/v0-paper-sma/reports/screenshots/`. The logical-state artifacts
...
- 2026-04-19 (ui-designer): T32 + T_FINAL_B landed. Added
  ...
  committed under `spec/v0-paper-sma/reports/screenshots/` +
  `spec/v0-paper-sma/reports/ui-week2-smoke-checklist-2026-04-18.md`. Four new
...
- **T31 binary name corrected** (`spec/v0-paper-sma/tasks.md`): The
