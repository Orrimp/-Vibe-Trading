...
- [x] **T25** [developer] — Backtest loop in `backtest` binary: reads
  ...
  `spec/<feature>/reports/backtest-<stamp>-<scenario>.md` per R5.5. Accepts
...
- [x] **T_FINAL_A** [developer] — End-to-end backtest runs:
  ...
  reports under `spec/<slug>/reports/`, both with
...
- [x] **T_FINAL_B** [ui-designer] — Cockpit smoke + kill-switch drill:
  ...
  screenshots committed to `spec/v0-paper-sma/reports/screenshots/`._
  **[deps: T28, T29, T32]**
  _note 2026-04-18 (ui-designer): smoke checklist committed at
  `spec/v0-paper-sma/reports/ui-week2-smoke-checklist-2026-04-18.md`; 16 logical-state
  artifacts committed under `spec/v0-paper-sma/reports/screenshots/`
  ...
  `spec/v0-paper-sma/reports/screenshots/README.md` — single reference
