...
- [x] **T1813** [developer] — Re-lock procedure (architect's
  ...
  - Per
    [`spec/dev-notes/memory-anchor-relock-TBD.md` → "What the
    eventual architect must do"](../dev-notes/memory-anchor-relock-TBD.md#what-the-eventual-architect-must-do),
  ...
  - The developer also **prepares the dev-note footer**:
    `spec/dev-notes/memory-anchor-relock-TBD.md` gains a
