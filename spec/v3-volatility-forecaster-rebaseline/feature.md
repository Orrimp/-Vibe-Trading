...
**retired — compressed 2026-06-17.** One-line description and version: see [CHANGELOG.md](../../CHANGELOG.md). Full narrative history: `git log -- spec/v3-volatility-forecaster-rebaseline/`. Backtest evidence (if any) is preserved under `reports/`.
