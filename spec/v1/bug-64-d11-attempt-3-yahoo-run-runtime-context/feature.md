...
**shipped — compressed 2026-06-17.** One-line description and version: see [CHANGELOG.md](../../../CHANGELOG.md). Full narrative history: `git log -- spec/bug-64-d11-attempt-3-yahoo-run-runtime-context/`. Backtest evidence (if any) is preserved under `reports/`.
