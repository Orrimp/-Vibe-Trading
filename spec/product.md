...
| v2.5  | DL forecaster portfolio trained in [`candle`](https://github.com/huggingface/candle) — 4-phase progression: v2.5 [TCN](v25-tcn-overlay/feature.md) → v2.5a [PatchTST](v25a-patchtst-overlay/feature.md) → v2.5b [Vanilla Transformer](v25b-transformer-overlay/feature.md) → v2.6 [bake-off + retirement](v26-forecast-bakeoff/feature.md). Umbrella: [`v25-dl-forecast-overlay`](v25-dl-forecast-overlay/feature.md); decision: [ADR-0028](architecture/adr/0028-v25-dl-forecast-overlay-candle.md) | Three model paradigms in production; canonical picked by evidence at v2.6 |
