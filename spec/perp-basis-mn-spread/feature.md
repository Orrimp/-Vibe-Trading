...
**presenter-done — compressed 2026-06-17.** One-line description and version: see [CHANGELOG.md](../../CHANGELOG.md). Full narrative history: `git log -- spec/perp-basis-mn-spread/`. Backtest evidence (if any) is preserved under `reports/`.
