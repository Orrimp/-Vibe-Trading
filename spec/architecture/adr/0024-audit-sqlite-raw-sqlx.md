...
The audit goal in [`../product.md`](../../product.md) requires every
...
goal locked in [`../product.md` § Project scope boundary](../../product.md#project-scope-boundary).
...
- Embedded SQLite WAL handles the v0 write rate (≤ a few hundred
  ...
  the file (see [`08-recovery-and-backups.md`](../08-recovery-and-backups.md)).
