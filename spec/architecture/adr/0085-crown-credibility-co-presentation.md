...
(`spec/dev-notes/dsr-report-only-decision-2026-07-09.md`).
...
- `spec/dev-notes/dsr-report-only-decision-2026-07-09.md` (D3 report-only — the
  decision this ADR honours; the veto stays unbuilt).
- `spec/dev-notes/do-not-build-register.md` row **E-1** (the veto dead-end).
