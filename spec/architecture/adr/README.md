...
status: in-progress
owner: architect
updated: 2026-05-30 (ADR-0045 § D6.3 + § D7.1b second-pass amendment — engine-drift BLOCKER: v5-realdata-medium namespace is provenance-MIXED; 6 macd/rsi/bbands determinism constants re-locked to SYNTHETIC SHAs via D7.1 override map, not anchors.toml; prior same-day: § D6 + § D7 dual-anchor reconciliation + drift-linter)
---
