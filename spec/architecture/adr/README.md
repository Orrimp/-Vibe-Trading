...
status: in-progress
owner: architect
updated: 2026-05-31 (ADR-0051 § D6.6 REAL-MECHANISM amendment — carry-strategy: a 2ND time series (funding) co-resampled under the SAME shared idx_seq as the returns ⇒ preserves funding↔price co-movement (FP-C1.5 cross-series), ZERO new RNG draws ⇒ SAME-paths determinism holds trivially, 87 anchors byte-identical by construction (additive Option fields + ScoreSource serde-default enum); seam (ii) funding_override mirrors bars_override, run_path stays CONCRETE; rejected extend-Bar + separate-CarryStrategy-struct as anchor-risk; +1 carry θ-surface anchor = 88; prior: 2026-05-31 ADR-0051 § D6.5 cross-ref amendment — cross-sectional mean-reversion 2nd strategy family, +1 MR anchor = 87; 2026-05-30 ADR-0045 § D6.3 + § D7.1b engine-drift)
---
