...
- This file: `spec/architecture/adr/0036-patchtst-training-contract.md`.
...
- `spec/architecture/adr/README.md` (+2 lines): registry row for ADR-0036 + changelog entry.
...
- 2026-05-21 (architect, M-T1): initial proposal. Status `proposed`
  ...
  [`spec/trace.toml`](../../trace.toml). Flips to `accepted` at
