...
- **Acceptance:** `cargo run -p ui --bin viewer --
  spec/reports/backtest-…-rsi-reversion.md` launches with
...
- **The `viewer` binary launches** against any of the 11
  anchored backtest reports under `spec/reports/`; KPI strip +
...
[`spec/tasks/lumen-phase-4-backtest-panel.md`](../tasks/lumen-phase-4-backtest-panel.md)._
...
- 2026-05-06 (developer): T1801–T1815 ticked with honest evidence in
  [`spec/tasks/lumen-phase-4-backtest-panel.md`](../tasks/lumen-phase-4-backtest-panel.md).
  Phase 4 ships:
...
`spec/reports/test-<timestamp>-lumen-phase-4-backtest-panel.md`._

## UI

_ui-designer fills this — links to refreshed snapshots and
the Phase 4 presentation under
`spec/presentations/lumen-phase-4-backtest-panel-<date>.md`._
