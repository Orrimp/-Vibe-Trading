...
- **Acceptance:** running both scenarios produces reports under
  `spec/reports/backtest-<stamp>-pairs-2023-zscore-mr.md` and
  `spec/reports/backtest-<stamp>-pairs-2024-h1-zscore-mr.md`
...
- **Baseline report:** Scenario 1's
  `spec/reports/backtest-<stamp>-pairs-2023-zscore-mr.md`.
...
- **V8 Cockpit smoke (R11).**
  - `cargo run --bin cockpit --features fixtures` against a
    ...
    `spec/reports/screenshots/v15a-mean-reversion-pairs/`).
...
- 2026-04-30 (architect): resolved analyst's Q1–Q10 (single Changelog
  ...
  [spec/tasks/v15a-mean-reversion-pairs.md](../tasks/v15a-mean-reversion-pairs.md).
