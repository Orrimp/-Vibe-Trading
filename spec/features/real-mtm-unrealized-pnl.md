...
follow-up brief `spec/features/per-symbol-position-accounts.md`
...
`spec/features/per-symbol-position-accounts.md` covers: (a) audit
...
| **V5** Anchor regression | `bash scripts/verify_anchors.sh` | (no fixture — gate over committed `spec/reports/success/*.md`) | `ANCHORS PASS  (11 / 11)`. |
...
- **T805** (feed-reconnect) and **T806** (mean-reversion-stop, in
  v1.5a vocabulary; see `spec/tasks/operator-success-reports.md`
