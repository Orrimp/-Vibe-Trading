...
> `spec/features/lumen-phase-N-<name>.md` and runs the standard pipeline.
...
Each phase is its own `spec/features/lumen-phase-N-<name>.md` brief
...
- **`lumen-phase-2-shell-ia-charts`** — promotes next (Phase 1
  ...
  [`spec/features/lumen-phase-2-shell-ia-charts.md`](lumen-phase-2-shell-ia-charts.md)
- **`lumen-phase-3-detail-screens`** — promotes on Phase 2 ship.
  Status: queued.
  [`spec/features/lumen-phase-3-detail-screens.md`](lumen-phase-3-detail-screens.md)
- **`lumen-phase-4-backtest-panel`** — promotes on Phase 3 ship.
  Status: queued. (Was originally Phase 2.)
  [`spec/features/lumen-phase-4-backtest-panel.md`](lumen-phase-4-backtest-panel.md)
- **`lumen-phase-5-humancontrol-agentfeed`** — promotes on Phase 4
  ship. Status: queued. (Was originally Phase 3.)
  [`spec/features/lumen-phase-5-humancontrol-agentfeed.md`](lumen-phase-5-humancontrol-agentfeed.md)
- **`lumen-phase-6-assistant-slot`** — `_reserved_`, linked to v2
  LLM. No analyst spawn until v2 LLM is approved. (Was originally
  Phase 4.)
  [`spec/features/lumen-phase-6-assistant-slot.md`](lumen-phase-6-assistant-slot.md)
