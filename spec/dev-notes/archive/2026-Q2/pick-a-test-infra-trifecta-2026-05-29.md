...
- [`spec/architecture/adr/0048-lab-recipe-test-harness.md`](../architecture/adr/0048-lab-recipe-test-harness.md) — parent ADR (D1-D6 carries forward across all three)
