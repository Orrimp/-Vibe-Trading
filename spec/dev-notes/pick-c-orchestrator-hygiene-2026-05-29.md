...
related:
  - spec/dev-notes/process-tooling-survey-2026-05-29.md
  - spec/dev-notes/pick-a-test-infra-trifecta-2026-05-29.md
  - spec/dev-notes/pick-b-cross-cutting-safety-duo-2026-05-29.md
  - spec/dev-notes/post-v3-strategy-direction-2026-05-29.md
  - spec/dev-notes/weekly-retro-2026-05-27-to-2026-05-29.md
...
1. The shared **"orchestrator pre-flight contract"** maturity ladder is
   ...
   start; ADR-registry lint fires on commit touching `spec/architecture/adr/`;
   ledger lint fires on commit touching `spec/dev-notes/operator-side-pending-ledger.md`
...
2. **`adr-registry-atomic-lint v0.1.0` SHIPPED** (operator-approved;
   ...
   exists, asserts: (a) every ADR file under `spec/architecture/adr/NNNN-*.md`
...
3. **`operator-ledger-schema-lint v0.1.0` SHIPPED** (operator-approved;
   ...
   exists, parses `spec/dev-notes/operator-side-pending-ledger.md`
...
- **ADR template file** (`spec/architecture/adr/TEMPLATE.md`) — has
...
The pending ledger
(`spec/dev-notes/operator-side-pending-ledger.md`) ALREADY exists
...
- [`spec/dev-notes/operator-side-pending-ledger.md`](operator-side-pending-ledger.md) — living ledger; lint target
...
- [`spec/architecture/adr/README.md`](../architecture/adr/README.md) — ADR registry table (lint target)
