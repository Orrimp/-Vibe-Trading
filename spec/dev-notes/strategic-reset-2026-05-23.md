...
related:
  ...
  - spec/dev-notes/feature-state-architect-review-2026-05-22.md
...
> tasks.md, (b) an issue in spec/dev-notes/, or (c) removal of the
...
spec_files = [
  ...
  "spec/dev-notes/shipped-partial-convention-2026-05-16.md",
  "spec/product.md",
...
Dev-note: spec/dev-notes/strategic-reset-2026-05-23.md
