...
- **Baseline report:** Scenario 1's
  `spec/v1-cross-sectional-momentum/reports/backtest-<stamp>-top10-2023-1h-momentum.md`.
...
- **V3 Both backtest scenarios run end-to-end.**
  ...
  - `top10-2024-h1-momentum` produces
    `spec/v1-cross-sectional-momentum/reports/backtest-<stamp>-top10-2024-h1-momentum.md`
