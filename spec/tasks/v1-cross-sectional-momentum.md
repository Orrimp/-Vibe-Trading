...
[spec/features/v1-cross-sectional-momentum.md → Design](../features/v1-cross-sectional-momentum.md#design)
...
- `spec/reports/screenshots/v0-paper-sma/README.md` —
...
- [x] **T_FINAL_B_v1** [ui-designer] — UI smoke (V8):
  ...
  - Screenshot under
    `spec/reports/screenshots/v1-cross-sectional-momentum/`
