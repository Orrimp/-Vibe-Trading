...
<!-- last-edited: 2026-05-06 (architect): created — Phase 5 (HumanControl + AgentFeed rename) task list filed against the architect-ratified `## Design` section in `spec/features/lumen-phase-5-humancontrol-agentfeed.md`. T1901–T1916 + `T_FINAL_LUMEN_PHASE_5`. HANDOFF → developer ‖ ui-designer. -->
...
> Spec context: [`spec/features/lumen-phase-5-humancontrol-agentfeed.md`](../features/lumen-phase-5-humancontrol-agentfeed.md)
...
- [x] T_FINAL_LUMEN_PHASE_5 — **Tester-owned. Developer never ticks
  ...
  - **Closing block (tester second-pass PASS):**
    - **Report:** [`spec/reports/test-2026-05-07b-lumen-phase-5-humancontrol-agentfeed.md`](../reports/test-2026-05-07b-lumen-phase-5-humancontrol-agentfeed.md)
    ...
    - **Routing:** `HANDOFF → presenter` (release mode). Phase 5
      brief frontmatter (`spec/features/lumen-phase-5-humancontrol-agentfeed.md`)
...
crates/ui/tests/snapshots/panel_snapshots__debug_screen__without_kill.snap   [REGEN (Q1) —
                                                 T1906]
spec/features/lumen-phase-5-humancontrol-agentfeed.md  [Design appended — architect, this
                                                 dispatch]
spec/tasks/lumen-phase-5-humancontrol-agentfeed.md     [NEW — this file]
...
- Master roadmap: [`spec/features/lumen-design-adoption.md`](../features/lumen-design-adoption.md).
- Phase 5 brief: [`spec/features/lumen-phase-5-humancontrol-agentfeed.md`](../features/lumen-phase-5-humancontrol-agentfeed.md).
- Phase 4 task list (template + T-numbering precedent + sub-block
  ui-designer-attestation pattern):
  [`spec/tasks/lumen-phase-4-backtest-panel.md`](lumen-phase-4-backtest-panel.md).
