...
sleep 4
screencapture -W spec/lumen-design-adoption/phase-2-shell-ia-charts/reports/screenshots/cockpit-home.png
...
screencapture -W spec/lumen-design-adoption/phase-2-shell-ia-charts/reports/screenshots/cockpit-debug.png
pkill -f "target/release/cockpit"
...
screencapture -W spec/lumen-design-adoption/phase-2-shell-ia-charts/reports/screenshots/cockpit-charts-with-markers.png
pkill -f "target/release/cockpit"
...
sleep 8
screencapture -W spec/lumen-design-adoption/phase-2-shell-ia-charts/reports/screenshots/cockpit-live-home.png
pkill -f "target/release/cockpit_live"
```

Referenced from [`spec/lumen-design-adoption/presentations/lumen-design-adoption-2026-05-04-to-05-08.md`](../../../../../spec/archive/presentations-2026-Q2.tar.gz) (phase-2-shell-ia-charts section of the consolidated retrospective).
